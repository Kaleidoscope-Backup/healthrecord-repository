...
type DataAccessLayer interface {
	...
	Get(id string, resource interface{}) (result interface{}, err error)
	// Get all records of a collection
	GetAll(resource interface{}) (results []interface{}, err error)
	...
	Search(baseURL url.URL, searchQuery search.Query, resourceType interface{}) (result *models.Bundle, err error)
