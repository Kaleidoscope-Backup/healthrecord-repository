...
// DataAccessLayer.
func NewResourceController(name string, resource interface{}, dal DataAccessLayer, config Config) *ResourceController {
...
func (rc *ResourceController) IndexHandler(c *gin.Context) {
	...
	bundle, err := rc.DAL.Search(*baseURL, searchQuery, nil)
	if err != nil {
...
func (rc *ResourceController) LoadResource(c *gin.Context) (interface{}, error) {
	result, err := rc.DAL.Get(c.Param("id"), rc.Resource)
