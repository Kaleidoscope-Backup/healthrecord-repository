...
// GetBSON translates the Karte extension syntax to a syntax that is more suitable for storage and sorting in MongoDB.
//
// Extension {
...
// SetBSON translates the stored extension syntax to the Karte extension syntax.
//
// bson.M {
//   "@context": bson.M {
//     "foo": bson.M {
...
// getTypeFromValueXFieldName takes in a Karte type with an uppercase letter and fixes it so it is lowercase if
// it is a Karte "primitive". This function has little to no value outside of the intended use case -- which is
