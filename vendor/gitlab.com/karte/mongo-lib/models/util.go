...
// This file is generated by the Karte golang generator.  This file should not be manually modified.
...
// When Karte JSON is unmarshalled, types that are interface{} just get unmarshaled to map[string]interface{}.
